...
import {
  ...
  AssetRedemptionTransactionResponse,
  SubmitAssetRedemptionResponse,
  GetAssetRedemptionInfoResponse,
} from "./api/responses";
...
export class AscendryClient {
   ...
   */
  public async submitTransactionToRpc(
   ...
   * @returns The vault NFTs.
   */
  async getVaultNftsByMint(nftMintAddress: string): Promise<GetNftsResponse> {
    const response = await axios.get(
  ...
  async getNftHistory(
    ...
    lastEvaluatedKey: string,
    paginationSize?: number,
  ): Promise<GetNftHistoryResponse> {
    const response = await axios.get(
      ENDPOINTS.GET_NFT_HISTORY(
        nftMintAddress,
        lastEvaluatedKey,
        paginationSize,
      ),
  ...
  async getLoansByNftMintAddress(
    nftMintAddress: string,
  ...
  async getAssetRedemptionInfo(
    nftMintAddress: string,
  ): Promise<GetAssetRedemptionInfoResponse> {
    const response = await axios.get(
  ...
  async getPresignedUrl(
    getPresignedUrlRequest: GetPresignedVendorMediaFileUrlRequest,
  ): Promise<GetPresignedVendorMediaFileUrlResponse> {
    try {
  ...
  async createVendorListing(
    uploadVendorListingRequest: UploadVendorListingRequest,
  ): Promise<UploadVendorListingResponse> {
    try {
      const response = await axios.post(
  ...
  ): Promise<GetVendorListingsResponse> {
    const response = await axios.get(
   ...
   * @returns The vendor listing.
   */
  async getVendorListingById(
    listingId: string,
  ): Promise<GetVendorListingByIdResponse> {
    const response = await axios.get(
   ...
   */
  async generateUnsignedLoanTransaction(
    loanInstructionRequest: LoanInstructionRequest,
   ...
   */
  async generateUnsignedAssetRedemptionTransaction(
    assetRedemptionInstructionRequest: AssetRedemptionInstructionRequest,
  ): Promise<AssetRedemptionTransactionResponse> {
    const response = await axios.post(
   ...
   */
  async submitAssetRedemptionRequest(
    submitAssetRedemptionRequest: SubmitAssetRedemptionRequest,
  ): Promise<SubmitAssetRedemptionResponse> {
    const response = await axios.post(
  ...
  async cancelVendorListing(
    cancelVendorListingRequest: CancelVendorListingRequest,
  ): Promise<CancelVendorListingResponse> {
    try {
      const response = await axios.post(
  ...
  async getPresignedUrlForViewing(
    fileKey: string,
  ): Promise<GetPresignedUrlForViewingResponse> {
    try {
      const response = await axios.get(
